          ...
          >
            <Card className="h-full bg-[#1a1a1a] border border-[#AE8737] hover:bg-[#AE8737]/10 hover:shadow-[0_0_15px_rgba(174,135,55,0.3)] transition-all duration-300 group">
              <CardContent className="p-8 text-center flex flex-col items-center justify-center h-full">
                ...
                <h3 className="mb-3 text-black text-xl font-semibold group-hover:text-[#AE8737] transition-colors">Telepon</h3>
          ...
          >
            <Card className="h-full bg-[#1a1a1a] border border-[#AE8737] hover:bg-[#AE8737]/10 hover:shadow-[0_0_15px_rgba(174,135,55,0.3)] transition-all duration-300 group">
              <CardContent className="p-8 text-center flex flex-col items-center justify-center h-full">
                ...
                <h3 className="mb-3 text-black text-xl font-semibold group-hover:text-[#AE8737] transition-colors">Email</h3>
          ...
          >
            <Card className="h-full bg-[#1a1a1a] border border-[#AE8737] hover:bg-[#AE8737]/10 hover:shadow-[0_0_15px_rgba(174,135,55,0.3)] transition-all duration-300 group">
              <CardContent className="p-8 text-center flex flex-col items-center justify-center h-full">
                ...
                <h3 className="mb-3 text-black text-xl font-semibold group-hover:text-[#AE8737] transition-colors">WhatsApp</h3>
                <span className="text-gray-200 text-lg font-medium tracking-wide">
                  +62 895 3040 7021
                </span>
              </CardContent>
